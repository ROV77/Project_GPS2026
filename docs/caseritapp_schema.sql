...
INSERT INTO
    delivery_vacancies_states (name)
VALUES
    ('open'),
    ('filled'),
    ('closed');
...
INSERT INTO
    delivery_applications_states (name)
VALUES
    ('pending'),
    ('accepted'),
    ('rejected');
...
INSERT INTO
    store_verifications_states (name)
VALUES
    ('pending'),
    ('approved'),
    ('rejected'),
...
-- 5) Foreign keys
-- =====================================================================
ALTER TABLE communes ADD CONSTRAINT fk_communes_region FOREIGN KEY (region_id) REFERENCES regions (id) ON DELETE SET NULL;
...
ALTER TABLE push_tokens ADD CONSTRAINT fk_pushtokens_user FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE;

ALTER TABLE addresses ADD CONSTRAINT fk_addresses_user FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE,
ADD CONSTRAINT fk_addresses_region FOREIGN KEY (region_id) REFERENCES regions (id) ON DELETE SET NULL,
ADD CONSTRAINT fk_addresses_commune FOREIGN KEY (commune_id) REFERENCES communes (id) ON DELETE SET NULL;

ALTER TABLE notifications ADD CONSTRAINT fk_notifications_user FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE;

ALTER TABLE stores ADD CONSTRAINT fk_stores_owner FOREIGN KEY (owner_id) REFERENCES users (id) ON DELETE RESTRICT,
ADD CONSTRAINT fk_stores_category FOREIGN KEY (category_id) REFERENCES categories (id) ON DELETE SET NULL,
ADD CONSTRAINT fk_stores_region FOREIGN KEY (region_id) REFERENCES regions (id) ON DELETE SET NULL,
ADD CONSTRAINT fk_stores_commune FOREIGN KEY (commune_id) REFERENCES communes (id) ON DELETE SET NULL;

ALTER TABLE products ADD CONSTRAINT fk_products_store FOREIGN KEY (store_id) REFERENCES stores (id) ON DELETE CASCADE;

ALTER TABLE store_payment_methods ADD CONSTRAINT fk_storepayments_store FOREIGN KEY (store_id) REFERENCES stores (id) ON DELETE CASCADE;

ALTER TABLE promotions ADD CONSTRAINT fk_promotions_store FOREIGN KEY (store_id) REFERENCES stores (id) ON DELETE CASCADE;

ALTER TABLE profile_analytics ADD CONSTRAINT fk_analytics_store FOREIGN KEY (store_id) REFERENCES stores (id) ON DELETE CASCADE;
...
ALTER TABLE delivery_vacancies ADD CONSTRAINT fk_vacancies_store FOREIGN KEY (store_id) REFERENCES stores (id) ON DELETE CASCADE,
ADD CONSTRAINT fk_vacancies_state FOREIGN KEY (state_id) REFERENCES delivery_vacancies_states (id) ON DELETE SET NULL;

ALTER TABLE delivery_applications ADD CONSTRAINT fk_applications_vacancy FOREIGN KEY (vacancy_id) REFERENCES delivery_vacancies (id) ON DELETE CASCADE,
ADD CONSTRAINT fk_applications_courier FOREIGN KEY (courier_id) REFERENCES users (id) ON DELETE CASCADE,
ADD CONSTRAINT fk_applications_state FOREIGN KEY (state_id) REFERENCES delivery_applications_states (id) ON DELETE SET NULL;

ALTER TABLE courier_ratings ADD CONSTRAINT fk_courierratings_courier FOREIGN KEY (courier_id) REFERENCES users (id) ON DELETE CASCADE,
ADD CONSTRAINT fk_courierratings_store FOREIGN KEY (store_id) REFERENCES stores (id) ON DELETE CASCADE;

ALTER TABLE store_verifications ADD CONSTRAINT fk_verifications_store FOREIGN KEY (store_id) REFERENCES stores (id) ON DELETE CASCADE,
ADD CONSTRAINT fk_verifications_reviewer FOREIGN KEY (reviewed_by) REFERENCES users (id) ON DELETE SET NULL,
ADD CONSTRAINT fk_verifications_state FOREIGN KEY (state_id) REFERENCES store_verifications_states (id) ON DELETE SET NULL;

ALTER TABLE subscriptions ADD CONSTRAINT fk_subscriptions_store FOREIGN KEY (store_id) REFERENCES stores (id) ON DELETE CASCADE,
ADD CONSTRAINT fk_subscriptions_plan FOREIGN KEY (plan_id) REFERENCES plans (id) ON DELETE SET NULL,
ADD CONSTRAINT fk_subscriptions_state FOREIGN KEY (state_id) REFERENCES subscriptions_states (id) ON DELETE SET NULL;
...
ADD CONSTRAINT fk_payments_state FOREIGN KEY (state_id) REFERENCES payments_states (id) ON DELETE SET NULL;
...
-- índices optimizados para filtros por región y comuna (agregados en feat:filtros)
...
CREATE INDEX idx_stores_region_verified ON stores (region_id, verified)
WHERE
    verified = true;

CREATE INDEX idx_stores_commune_verified ON stores (commune_id, verified)
WHERE
    verified = true;
