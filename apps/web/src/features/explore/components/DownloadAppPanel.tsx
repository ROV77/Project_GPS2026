...
export function DownloadAppPanel({
  ...
  return (
    <div className={cn('w-full relative overflow-hidden bg-gradient-to-br from-brand-900 via-brand-800 to-slate-950 shadow-inner mt-8', className)}>
      <div
      ...
      <div className="mx-auto w-full max-w-[1440px] px-5 sm:px-8 md:px-12 lg:px-16">
        <div className="relative py-6 md:flex md:items-center md:justify-between md:py-8">
          ...
          <div className="relative -mx-5 -mb-6 mt-6 h-[160px] overflow-hidden md:mx-0 md:-my-8 md:mt-0 md:h-[220px] md:w-[280px] md:shrink-0">
